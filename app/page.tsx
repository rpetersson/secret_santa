  ...
  return (
    <>
      ...
      <div className="hej">
        ...
        <form action={dropAllEntities} className="flex flex-col items-center justify-between">
          <button className="m-3 py-2 bg-blue-500 hover:bg-blue-700 text-white font-bold px-4 rounded " >Ta bort alla namn!</button>
        </form>
